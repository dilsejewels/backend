...
class ProductController extends Controller
{
    ...
    /* public function showProductById($id)
    {
        ...
        if ($product) {
            Log::info('Product Clarity Data:', [
                'product_id' => $product->products_id,
                'product_clarity_relation' => $product->productClarity,
                'product_clarity_id' => $product->product_clarity_id 
            ]);
        }
        ...
        return response()->json([
            ...
            'product' => [
                ...
                'delivery_days' => $product->delivery_days,
                'product_clarity' => $product->productClarity ? $product->productClarity->name : null,
                'product_modal' => $product->product_model ?? null,
                'stone_type' => $product->stone ? $product->stone->pst_name : null,
                'cut' => $product->diamondCut ? $product->diamondCut->name : null,
