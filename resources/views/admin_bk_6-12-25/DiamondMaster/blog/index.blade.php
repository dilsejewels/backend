      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            ...
            <textarea name="paragraph" id="paragraph" class="form-control" rows="8" placeholder="Write your blog content here..." required></textarea>
    ...
    columns: [
      { data: 'id' },
      {
        ...
        render: function(data) {
          if (data) {
            return `<img src="{{ asset('storage/blogs') }}/${data}" class="blog-image" alt="Blog Image">`;
          }
  ...
  $.ajax({
    ...
    success: function(response) {
      if (response.success && response.data) {
        ...
        if (blog.image) {
          $('#imagePreview').html(`
            <img src="{{ asset('storage/blogs') }}/${blog.image}" class="image-preview" alt="Current Image">
